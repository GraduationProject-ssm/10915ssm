...
public class ShangchuanhesuanjiancebaogaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShangchuanhesuanjiancebaogaoEntity() {
		
	}
	
	public ShangchuanhesuanjiancebaogaoEntity(T t) {
		try {
