...
public class YishengController {
    ...
    public R page(@RequestParam Map<String, Object> params,YishengEntity yisheng, 
                @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date yuyueshijianduanstart,
                @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date yuyueshijianduanend,
		HttpServletRequest request){

        EntityWrapper<YishengEntity> ew = new EntityWrapper<YishengEntity>();
                if(yuyueshijianduanstart!=null) ew.ge("yuyueshijianduan", yuyueshijianduanstart);
                if(yuyueshijianduanend!=null) ew.le("yuyueshijianduan", yuyueshijianduanend);
